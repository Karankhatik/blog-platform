...
import { setIsOpenTOCState, setIsOpenChapterState, setIsOpenReadabilityState } from '@/store/isOpenSlice';
            ...
            <div className="flex flex-col left-0 w-64 bg-white h-full ">
                ...
                <div className="">
                    <ul className="flex flex-col py-4 space-y-1">
                        ...
                        <li>
                            <Link href="/dashboard/users" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                                {/* <span className="inline-flex justify-center items-center ml-4">
                        ...
                        <li>
                            <Link href="/dashboard/courses" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                                {/* <span className="inline-flex justify-center items-center ml-4">
                        ...
                        <li>
                            <Link href="/dashboard/chapters" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                                {/* <span className="inline-flex justify-center items-center ml-4">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                                </span> */}
                                <span className="ml-2 text-sm tracking-wide truncate">Chapters</span>                                
                            </Link>
                        </li>
                        <li>
                            <Link href="/dashboard/media" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                                {/* <span className="inline-flex justify-center items-center ml-4">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                                </span> */}
                                <span className="ml-2 text-sm tracking-wide truncate">Media</span>                                
                            </Link>
                        </li>
                        {/* <li className="px-5">
                            <div className="flex flex-row items-center h-8">
